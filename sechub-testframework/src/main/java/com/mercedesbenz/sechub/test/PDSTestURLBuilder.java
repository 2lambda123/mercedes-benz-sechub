...
public class PDSTestURLBuilder extends AbstractTestURLBuilder {
  ...
  private static final String API_PDS_INTEGRATIONTEST =
      "/api/anonymous/integrationtest";
  ...
  public String buildCreateJob() { return buildUrl(API_PDS_JOB, "create"); }
  ...
  public String buildBaseUrl() { return buildUrl(""); }

  public String
  buildIntegrationTestFetchStoragePathHistoryEntryForSecHubJob(UUID jobUUID) {
  ...
  public String
  buildIntegrationTestFetchAutoCleanupInspectionDeleteCountsUrl() {
    return buildUrl(API_ANONYMOUS,
                    "integrationtest/autocleanup/inspection/deleteCounts");
  }

  public String buildIntegrationTestResetAutoCleanupInspectionUrl() {
    return buildUrl(API_ANONYMOUS,
                    "integrationtest/autocleanup/inspection/reset");
  }
