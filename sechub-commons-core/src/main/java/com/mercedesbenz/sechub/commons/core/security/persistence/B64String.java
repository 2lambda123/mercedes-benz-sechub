...
public class B64String {
  ...
  private B64String(String b64String) { this.b64String = b64String; }
  ...
  public String getString() { return getBytes().toString(); }

  public byte[] getBytes() { return Base64.getDecoder().decode(b64String); }
